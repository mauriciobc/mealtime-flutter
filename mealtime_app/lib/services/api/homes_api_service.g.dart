...
part of 'homes_api_service.dart';
...
class _HomesApiService implements HomesApiService {
  _HomesApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ApiResponse<List<HouseholdModel>>> getHouseholds() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<HouseholdModel>>>(
    ...
    late ApiResponse<List<HouseholdModel>> _value;
    try {
      _value = ApiResponse<List<HouseholdModel>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<HouseholdModel>(
                    (i) => HouseholdModel.fromJson(i as Map<String, dynamic>),
                  )
                  .toList()
            : List.empty(),
      );
  ...
  Future<ApiResponse<HouseholdModel>> createHousehold({
    ...
    final _headers = <String, dynamic>{};
    final _data = {'name': name, 'description': description};
    _data.removeWhere((k, v) => v == null);
    final _options = _setStreamType<ApiResponse<HouseholdModel>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<HouseholdModel> _value;
    try {
      _value = ApiResponse<HouseholdModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<ApiResponse<HouseholdModel>> getHouseholdById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ApiResponse<EmptyResponse>> deleteHousehold(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ApiResponse<EmptyResponse>> setActiveHousehold(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ApiResponse<dynamic>> regenerateInviteCode(String householdId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<ApiResponse<List<dynamic>>> getHouseholdFeedingLogs({
    ...
    final _options = _setStreamType<ApiResponse<List<dynamic>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/households/${householdId}/feeding-logs',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
