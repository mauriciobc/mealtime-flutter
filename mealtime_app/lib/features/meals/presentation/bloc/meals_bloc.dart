...
class MealsBloc extends Bloc<MealsEvent, MealsState> {
  ...
  // Helper function to format DateTime, moved from the widget to the BLoC.
  // This pre-calculates the display string, preventing expensive operations
  // inside the build method of the UI.
  ...
  // Helper function to map a single meal to a view model.
  ...
  // Helper function to map a list of meals to a list of view models.
