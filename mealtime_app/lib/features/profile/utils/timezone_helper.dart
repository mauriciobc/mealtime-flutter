/// Lista completa de timezones IANA válidos
/// Baseado na lista oficial do IANA Time Zone Database (tzdata 2025b, zone1970.tab)
/// Total: 313 timezones (312 do zone1970.tab + UTC)
class TimezoneHelper {
  static final List<String> _allTimezones = [
    'Africa/Abidjan',
    'Africa/Algiers',
    'Africa/Bissau',
    'Africa/Cairo',
  ...
  /// Retorna todos os timezones disponíveis
  static List<String> get allTimezones => List.unmodifiable(_allTimezones);

  /// Busca timezones que correspondem ao texto fornecido (case-insensitive)
  static List<String> searchTimezones(String query) {
    ...
    return _allTimezones
        ...
        .take(20) // Limitar a 20 resultados para melhor performance
        .toList();
  }
