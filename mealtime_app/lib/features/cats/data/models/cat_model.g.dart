...
CatModel _$CatModelFromJson(Map<String, dynamic> json) => CatModel(
  ...
  portionSize: const DoubleConverter().fromJson(json['portion_size']),
  portionUnit: json['portion_unit'] as String?,
  feedingInterval: const IntConverter().fromJson(json['feeding_interval']),
...
Map<String, dynamic> _$CatModelToJson(CatModel instance) => <String, dynamic>{
  ...
  'portion_size': const DoubleConverter().toJson(instance.portionSize),
  'portion_unit': instance.portionUnit,
  'feeding_interval': const IntConverter().toJson(instance.feedingInterval),
