...
class Household extends DataClass implements Insertable<Household> {
  ...
  @override
  int get hashCode => Object.hash(id, createdAt, updatedAt, syncedAt, version,
      name, address, description, ownerId, inviteCode, isActive, isDeleted);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Household &&
...
class $CatsTable extends Cats with TableInfo<$CatsTable, Cat> {
  ...
  late final GeneratedColumn<String> photoUrl = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string,
      requiredDuringInsert: false);
  static const VerificationMeta _restrictionsMeta =
      const VerificationMeta('restrictions');
  @override
  late final GeneratedColumn<String> restrictions = GeneratedColumn<String>(
      'restrictions', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _feedingIntervalMeta =
      const VerificationMeta('feedingInterval');
  @override
  late final GeneratedColumn<int> feedingInterval = GeneratedColumn<int>(
      'feeding_interval', aliasedName, true,
  ...
  Cat map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Cat(
      ...
      restrictions: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}restrictions']),
      feedingInterval: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}feeding_interval']),
      isActive: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}is_active'])!,
      isDeleted: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}is_deleted'])!,
...
class Cat extends DataClass implements Insertable<Cat> {
  ...
  Cat copyWith(
      ...
      Cat(
        ...
        restrictions:
            restrictions.present ? restrictions.value : this.restrictions,
...
class $FeedingLogsTable extends FeedingLogs
  ...
  @override
  VerificationContext validateIntegrity(Insertable<FeedingLog> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
    ...
    if (data.containsKey('fed_by')) {
      context.handle(
          _fedByMeta, fedBy.isAcceptableOrUnknown(data['fed_by']!, _fedByMeta));
    } else if (isInserting) {
  ...
  FeedingLog map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return FeedingLog(
      ...
      fedBy: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}fed_by'])!,
...
class Schedule extends DataClass implements Insertable<Schedule> {
  ...
  @override
  int get hashCode => Object.hash(id, createdAt, updatedAt, syncedAt, version,
      catId, type, interval, times, enabled, isDeleted);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Schedule &&
...
class WeightLog extends DataClass implements Insertable<WeightLog> {
  ...
  @override
  int get hashCode => Object.hash(id, createdAt, updatedAt, syncedAt, version,
      catId, weight, measuredAt, notes, isDeleted);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is WeightLog &&
...
class SyncOperation extends DataClass implements Insertable<SyncOperation> {
  ...
  @override
  int get hashCode => Object.hash(id, entityType, operation, localId, remoteId,
      payload, createdAt, lastAttempt, attemptCount, isCompleted, errorMessage);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final FeedingLogsDao feedingLogsDao =
...
final class $$ProfilesTableReferences
  ...
  static MultiTypedResultKey<$HouseholdsTable, List<Household>>
      _householdsRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.households,
              aliasName:
                  $_aliasNameGenerator(db.profiles.id, db.households.ownerId));
  ...
  static MultiTypedResultKey<$CatsTable, List<Cat>> _catsRefsTable(
          _$AppDatabase db) =>
      MultiTypedResultKey.fromTable(db.cats,
  ...
  static MultiTypedResultKey<$FeedingLogsTable, List<FeedingLog>>
      _feedingLogsRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.feedingLogs,
              aliasName:
                  $_aliasNameGenerator(db.profiles.id, db.feedingLogs.fedBy));

  $$FeedingLogsTableProcessedTableManager get feedingLogsRefs {
    final manager = $$FeedingLogsTableTableManager($_db, $_db.feedingLogs)
        .filter((f) => f.fedBy.id($_item.id));
...
class $$ProfilesTableTableManager extends RootTableManager<
    ...
    PrefetchHooks Function(
        {bool householdsRefs, bool catsRefs, bool feedingLogsRefs})> {
                ...
                return [
                  if (householdsRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable:
                            $$ProfilesTableReferences._householdsRefsTable(db),
                  ...
                  if (catsRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable:
                            $$ProfilesTableReferences._catsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                  ...
                  if (feedingLogsRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable:
                            $$ProfilesTableReferences._feedingLogsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$ProfilesTableReferences(db, table, p0)
                                .feedingLogsRefs,
                        referencedItemsForCurrentItem: (item,
                                referencedItems) =>
                            referencedItems.where((e) => e.fedBy == item.id),
                        typedResults: items)
                ];
              },
            );
...
final class $$HouseholdsTableReferences
  ...
  static MultiTypedResultKey<$CatsTable, List<Cat>> _catsRefsTable(
      ...
      MultiTypedResultKey.fromTable(db.cats,
          aliasName:
              $_aliasNameGenerator(db.households.id, db.cats.householdId));

  $$CatsTableProcessedTableManager get catsRefs {
    final manager = $$CatsTableTableManager($_db, $_db.cats)
        .filter((f) => f.householdId.id($_item.id));
      ...
      _feedingLogsRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.feedingLogs,
              aliasName: $_aliasNameGenerator(
                  db.households.id, db.feedingLogs.householdId));
...
class $$HouseholdsTableTableManager extends RootTableManager<
    ...
    Household,
    PrefetchHooks Function(
        {bool ownerId, bool catsRefs, bool feedingLogsRefs})> {
              ...
              addJoins: <
                ...
                if (ownerId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$HouseholdsTableReferences._ownerIdTable(db),
                    referencedColumn:
                        $$HouseholdsTableReferences._ownerIdTable(db).id,
                  ) as T;
                }
                ...
                return [
                  if (catsRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable:
                            $$HouseholdsTableReferences._catsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$HouseholdsTableReferences(db, table, p0).catsRefs,
...
final class $$CatsTableReferences
  ...
  $$HouseholdsTableProcessedTableManager? get householdId {
    if ($_item.householdId == null) return null;
    final manager = $$HouseholdsTableTableManager($_db, $_db.households)
        .filter((f) => f.id($_item.householdId!));
...
class $$CatsTableFilterComposer extends Composer<_$AppDatabase, $CatsTable> {
  ...
  ColumnFilters<String> get restrictions => $composableBuilder(
      column: $table.restrictions, builder: (column) => ColumnFilters(column));
...
class $$CatsTableAnnotationComposer
  ...
  GeneratedColumn<String> get restrictions => $composableBuilder(
      column: $table.restrictions, builder: (column) => column);

  GeneratedColumn<int> get feedingInterval => $composableBuilder(
      column: $table.feedingInterval, builder: (column) => column);
              ...
              addJoins: <
                ...
                if (householdId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$CatsTableReferences._householdIdTable(db),
                    referencedColumn:
                        $$CatsTableReferences._householdIdTable(db).id,
                  ) as T;
                }
                if (ownerId) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.ownerId,
                    referencedTable: $$CatsTableReferences._ownerIdTable(db),
                    referencedColumn:
                        $$CatsTableReferences._ownerIdTable(db).id,
                  ) as T;
                }
                ...
                return [
                  if (feedingLogsRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable:
                            $$CatsTableReferences._feedingLogsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                  ...
                  if (schedulesRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable:
                            $$CatsTableReferences._schedulesRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$CatsTableReferences(db, table, p0).schedulesRefs,
                        referencedItemsForCurrentItem: (item,
                                referencedItems) =>
                            referencedItems.where((e) => e.catId == item.id),
                        typedResults: items),
                  if (weightLogsRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable:
                            $$CatsTableReferences._weightLogsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$CatsTableReferences(db, table, p0).weightLogsRefs,
                        referencedItemsForCurrentItem: (item,
                                referencedItems) =>
                            referencedItems.where((e) => e.catId == item.id),
                        typedResults: items)
...
typedef $$FeedingLogsTableUpdateCompanionBuilder = FeedingLogsCompanion
    Function({
  Value<String> id,
  Value<DateTime> createdAt,
  Value<DateTime> updatedAt,
...
final class $$FeedingLogsTableReferences
  ...
  static $CatsTable _catIdTable(_$AppDatabase db) => db.cats
      .createAlias($_aliasNameGenerator(db.feedingLogs.catId, db.cats.id));
  ...
  $$ProfilesTableProcessedTableManager? get fedBy {
    if ($_item.fedBy == null) return null;
    final manager = $$ProfilesTableTableManager($_db, $_db.profiles)
        .filter((f) => f.id($_item.fedBy!));
...
class $$FeedingLogsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $FeedingLogsTable,
    FeedingLog,
    $$FeedingLogsTableFilterComposer,
              ...
              addJoins: <
                ...
                if (catId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$FeedingLogsTableReferences._catIdTable(db),
                    referencedColumn:
                        $$FeedingLogsTableReferences._catIdTable(db).id,
                  ) as T;
                }
                if (householdId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.householdId,
                    referencedTable:
                        $$FeedingLogsTableReferences._householdIdTable(db),
                    referencedColumn:
                        $$FeedingLogsTableReferences._householdIdTable(db).id,
                  ) as T;
                }
                if (fedBy) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$FeedingLogsTableReferences._fedByTable(db),
                    referencedColumn:
                        $$FeedingLogsTableReferences._fedByTable(db).id,
                  ) as T;
                }
...
typedef $$FeedingLogsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $FeedingLogsTable,
    FeedingLog,
    $$FeedingLogsTableFilterComposer,
              ...
              addJoins: <
                ...
                if (catId) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.catId,
                    referencedTable: $$SchedulesTableReferences._catIdTable(db),
                    referencedColumn:
                        $$SchedulesTableReferences._catIdTable(db).id,
                  ) as T;
                }
...
final class $$WeightLogsTableReferences
  ...
  static $CatsTable _catIdTable(_$AppDatabase db) => db.cats
      .createAlias($_aliasNameGenerator(db.weightLogs.catId, db.cats.id));
              ...
              addJoins: <
                ...
                if (catId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.catId,
                    referencedTable:
                        $$WeightLogsTableReferences._catIdTable(db),
                    referencedColumn:
                        $$WeightLogsTableReferences._catIdTable(db).id,
                  ) as T;
                }
